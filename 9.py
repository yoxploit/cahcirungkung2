   ...
   try:
     ...
     #try:
        ...
        if _lowercase(obj["Interface"]["Random"]["Auto"]) == "on":
           ...
           if cok == 3:
              chance = blue+" "+str(hasil_chance)+"   "+"%"+" "+hijau
           if cok == 4:
              chance = blue+" "+str(hasil_chance)+"  "+"%"+" "+hijau
           if cok == 5:
              chance = blue+" "+str(hasil_chance)+" "+"%"+" "+hijau
           ...
           chance = hijau+"  "+str(obj["Interface"]["Chance"])+" %"+" "+red
        ...
        if blance > ws:
           if _lowercase(obj["Interface"]["Random"]["Auto"]) == "on":
              print ('\x1b[0;30;42m'+" "+str(rolebet)+" "+'\x1b[0m'+" "+red+str(rev(str(amount))),"Profit",ij+rev(str(profw)),ij+str(rev(str(blance)))+rs+" "+chance)
              print ('\x1b[1;32;100m'+" "*18+"STOP TARGET BALANCE"+" "*18+'\x1b[0m')
           else:
              print ('\x1b[0;30;42m'+" "+str(rolebet)+" "+'\x1b[0m'+" "+red+str(rev(str(amount))),"Profit",ij+rev(str(profw)),kn+str(rev(str(blance)))+rs)
        ...
        if jsn["PayOut"] is not a:
           ...
           if prof > 0:
              if _lowercase(obj["Interface"]["Random"]["Auto"]) == "on":
                 print ('\x1b[0;30;42m'+" "+str(rolebet)+" "+'\x1b[0m'+" "+blue+str(rev(str(amount))),"Profit",ij+rev(str(profw)),kn+str(rev(str(bal)))+rs+" "+chance)
              else:
                 print ('\x1b[0;30;42m'+" "+str(rolebet)+" "+'\x1b[0m'+" "+blue+str(rev(str(amount))),"Profit",ij+rev(str(profw)),kn+str(rev(str(bal)))+rs)
           else:
        ...
        if no_lose > total_lose:
           ...
           stats_rolebet_win = False
           total_lose +=1
        sys.stdout.write("  "+seed_on_off+rs+kn+" "+bg_ij+" "+str(total_win)+" "+bg_end+" "+red+" "+str(total_lose)+" "+bg_end+" "+chance+" Roll : "+str(total_roll)+"\r")
